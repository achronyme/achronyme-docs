---
title: "Do Blocks"
description: "Multi-statement expressions, local scope, intermediate computations, and complex lambda bodies with do block syntax"
...
**Note**: Recursion limited to ~50 calls (see [Performance](../advanced-topics/performance.md))
...
See [Performance](../advanced-topics/performance.md) for details.
