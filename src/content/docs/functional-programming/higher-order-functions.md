...
description: "Map, filter, reduce, pipe, and predicate functions for functional data transformations in Achronyme"
...
// Find in range
find(range(1, 100), x => x * x > 50)  // 8 (8^2 = 64 > 50)
...
find(numbers, x => x * x > 20)  // 5 (5^2 = 25)
