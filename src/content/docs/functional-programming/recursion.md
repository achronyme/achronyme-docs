...
description: "Recursive functions with rec keyword, recursion patterns, depth limits, tail recursion, and alternatives to recursion"
...
### Critical Limitation: ~50 Call Depth
...
**Why safe**: Logarithmic depth (log2 n).
...
|---------|-----------|-----|
| Sum array | No | Use `sum()` or `reduce()` |
| Factorial < 40 | Yes | Natural recursion, safe depth |
| Range 0..n | No | Use `linspace()` |
| Tree traversal | Yes | Natural recursion, limited depth |
| GCD | Yes | Natural recursion, logarithmic depth |
| Fibonacci | Caution | Natural but slow; limit to small n |
| Binary search | Yes | Natural recursion, logarithmic depth |
...
// Test progressively
factorial(5)   // Test
factorial(10)  // Increase
factorial(20)  // Keep going
factorial(40)  // Near limit
```
...
- [Performance](../advanced-topics/performance.md) - Detailed depth limits
