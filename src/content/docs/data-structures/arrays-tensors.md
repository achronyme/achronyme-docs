...
description: "N-dimensional numerical arrays, vectors, element-wise operations, broadcasting, and array manipulation in Achronyme"
...
**Next**: [Indexing and Slicing](indexing-slicing.md)
