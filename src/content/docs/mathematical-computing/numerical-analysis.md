...
description: "Differentiation, integration (trapezoid, Simpson, Romberg), root finding (bisection, Newton, secant), and optimization algorithms"
...
See [Optimization](../specialized-modules/optimization.md) for linear programming and optimization details.
