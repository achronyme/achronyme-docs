...
description: "Complex number literals, arithmetic operations, polar form, mathematical functions, and ComplexTensor support for signal processing"
...
**Next**: [Numerical Analysis](numerical-analysis.md)
