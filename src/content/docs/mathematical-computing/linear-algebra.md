...
description: "Vector and matrix operations, decompositions (LU, QR, Cholesky, SVD), eigenvalue problems, and linear system solving with the faer backend"
...
**Next**: [Complex Numbers](complex-numbers.md)
