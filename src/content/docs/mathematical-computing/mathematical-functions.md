...
description: "Trigonometric, exponential, logarithmic, power, rounding, and utility functions with mathematical constants"
...
```javascript
// Arcsine - range: [-pi/2, pi/2]
asin(0)                // 0
asin(1)                // pi/2
asin(-1)               // -pi/2

// Arccosine - range: [0, pi]
acos(1)                // 0
acos(0)                // pi/2
acos(-1)               // pi

// Arctangent - range: (-pi/2, pi/2)
atan(0)                // 0
atan(1)                // pi/4
atan(-1)               // -pi/4
```
...
```javascript
// atan2(y, x) - full circle range: (-pi, pi]
// Handles quadrants correctly

atan2(1, 1)            // pi/4 (first quadrant)
atan2(1, -1)           // 3pi/4 (second quadrant)
atan2(-1, -1)          // -3pi/4 (third quadrant)
...
// Negative numbers
floor(-3.7)            // -4 (towards -infinity)
ceil(-3.7)             // -3 (towards +infinity)
...
See [Complex Numbers](complex-numbers.md) for more details.
