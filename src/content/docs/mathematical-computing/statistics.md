---
title: "Statistics"
description: "Descriptive statistics (sum, mean, std, variance), extrema functions, and vector operations for data analysis"
...
**Next**: [Digital Signal Processing](../specialized-modules/dsp.md)
