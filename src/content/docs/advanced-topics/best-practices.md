...
description: "Code style conventions, naming guidelines, function design patterns, performance optimization, and error handling strategies"
...
**See Also**:
- [Functions and Lambdas](../core-language/functions.md) - Function basics
- [Do Blocks](../functional-programming/do-blocks.md) - Multi-statement blocks
- [Recursion Patterns](../functional-programming/recursion.md) - Recursive best practices
