...
description: "Stack overflow with deep recursion, workarounds using built-in functions, recursion depth limits, and performance comparison of different approaches"
...
**See Also**:
- [Functions and Lambdas](../core-language/functions.md) - Recursion basics
- [Higher-Order Functions](../functional-programming/higher-order-functions.md) - Alternatives to recursion
