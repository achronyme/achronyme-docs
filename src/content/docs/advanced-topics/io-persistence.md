...
description: "Save and restore REPL environments with save_env, restore_env, env_info functions, compression options, metadata, and .ach binary format"
...
- [Variables](../core-language/variables.md) - Variable declaration and scoping
- [Records](../data-structures/records.md) - Working with records
- [Utilities](utilities.md) - print, type, str functions
