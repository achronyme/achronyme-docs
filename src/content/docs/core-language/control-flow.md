---
title: "Control Flow"
description: "Conditional expressions with if() function, piecewise() for multiple conditions, if-else blocks, early return statements, and control flow patterns"
...
**Next**: [Arrays and Tensors](../data-structures/arrays-tensors.md)
