...
description: "First-class functions, lambda syntax, closures, recursion with rec keyword, and functional programming patterns in Achronyme"
...
**IMPORTANT**: Achronyme currently has a strict limit of approximately **50 recursive calls** before encountering stack overflow.
...
See [Performance Limitations](../advanced-topics/performance.md) for details and workarounds.
